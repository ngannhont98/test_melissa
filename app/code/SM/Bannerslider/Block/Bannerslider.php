...
class Bannerslider extends \Magento\Framework\View\Element\Template
{
     ...
     * @var string
     */
    protected $_template = 'SM_Bannerslider::bannerslider.phtml';
    ...
    public function __construct(
        ...
        \SM\Bannerslider\Model\ResourceModel\Banner\CollectionFactory $bannerCollectionFactory,
        array $data = []
    ) {
     ...
     *
     * @param \SM\Bannerslider\Model\ResourceModel\Slider\Collection $sliderCollection [description]
     *
     * @return \SM\Bannerslider\Block\Bannerslider [description]
     */
    public function appendChildBlockSliders(
        \SM\Bannerslider\Model\ResourceModel\Slider\Collection $sliderCollection
    ) {
        foreach ($sliderCollection as $slider) {
            $this->append(
                $this->getLayout()->createBlock(
                    'SM\Bannerslider\Block\SliderItem'
