    ...
    protected function _prepareForm()
    {
        ...
        $fieldMaps['sort_type'] = $fieldset->addField(
            ...
            [
                ...
                'values' => [
                    [
                        'value' => \SM\Bannerslider\Model\Slider::SORT_TYPE_RANDOM,
                        'label' => __('Random'),
                    ],
                    [
                        'value' => \SM\Bannerslider\Model\Slider::SORT_TYPE_ORDERLY,
                        'label' => __('Orderly'),
                    ],
                ],
            ]
        ...
        $positionImage = [];
        for ($i = 1; $i <= 5; ++$i) {
            $positionImage[] = $this->getViewFileUrl("SM_Bannerslider::images/position/bannerslider-ex{$i}.png");
        }
