...
namespace SM\Bannerslider\Block\Adminhtml;
...
class Preview extends \Magento\Backend\Block\Template
{
     ...
     */
    const STYLESLIDE_EVOLUTION_PREVIEW_TEMPLATE = 'SM_Bannerslider::slider/preview/evolution.phtml';
    const STYLESLIDE_SPECIAL_NOTE_PREVIEW_TEMPLATE = 'SM_Bannerslider::slider/preview/special/note.phtml';
    const STYLESLIDE_FLEXSLIDER_PREVIEW_TEMPLATE = 'SM_Bannerslider::slider/preview/flexslider.phtml';
