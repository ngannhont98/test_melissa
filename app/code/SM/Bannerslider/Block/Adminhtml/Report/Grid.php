 ...
 */
namespace SM\Bannerslider\Block\Adminhtml\Report;
use SM\Bannerslider\Model\ResourceModel\Report\Collection as ReportCollection;
/**
 * Report grid.
 * @category SM
 * @package  SM_Bannerslider
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
     ...
     * report factory.
     *
     * @var \SM\Bannerslider\Model\ReportFactory
     */
     ...
     * @param \SM\Bannerslider\Model\ResourceModel\Report\CollectionFactory $reportCollectionFactory
     * @param array                                                           $data
     */
    public function __construct(
        \Magento\Backend\Block\Template\Context $context,
        \Magento\Backend\Helper\Data $backendHelper,
        \SM\Bannerslider\Model\ResourceModel\Report\CollectionFactory $reportCollectionFactory,
        array $data = []
    ) {
    ...
    {
        /** @var \SM\Bannerslider\Model\ResourceModel\Report\Collection $collection */
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'filter' => false,
                'index' => 'imagename',
                'renderer' => 'SM\Bannerslider\Block\Adminhtml\Report\Helper\Renderer\Image',
            ]
        );
        $this->addColumn(
            'date_click',
