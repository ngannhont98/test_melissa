 ...
 * @author   SM Developer
 */
class Save extends \SM\Bannerslider\Controller\Adminhtml\Banner
{
    /**
            ...
            if ($imageRequest && strlen($fileName)) {
                ...
                try {
                    ...
                    $result = $uploader->save(
                        $mediaDirectory->getAbsolutePath(\SM\Bannerslider\Model\Banner::BASE_MEDIA_PATH)
                    );
                    $data['image'] = \SM\Bannerslider\Model\Banner::BASE_MEDIA_PATH.$result['file'];
                } catch (\Exception $e) {
                    if ($e->getCode() == 0) {
