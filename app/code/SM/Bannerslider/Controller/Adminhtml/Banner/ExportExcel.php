 ...
 * @author   SM Developer
 */
class ExportExcel extends \SM\Bannerslider\Controller\Adminhtml\Banner
{
    public function execute()
    {
        ...
        $content = $resultPage->getLayout()->createBlock('SM\Bannerslider\Block\Adminhtml\Banner\Grid')->getExcel();
