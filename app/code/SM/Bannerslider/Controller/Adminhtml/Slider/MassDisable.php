 ...
 * @author   SM Developer
 */
class MassDisable extends \SM\Bannerslider\Controller\Adminhtml\AbstractAction
{
    ...
    {
        $sliderCollection = $this->_objectManager->create('SM\Bannerslider\Model\ResourceModel\Slider\Collection');
