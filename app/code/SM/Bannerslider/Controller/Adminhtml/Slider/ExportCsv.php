 ...
 * @author   SM Developer
 */
class ExportCsv extends \SM\Bannerslider\Controller\Adminhtml\Slider
{
    public function execute()
    {
        ...
        $content = $resultPage->getLayout()->createBlock('SM\Bannerslider\Block\Adminhtml\Slider\Grid')->getCsv();
