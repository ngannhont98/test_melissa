 ...
 * @author   SM Developer
 */
abstract class Report extends \SM\Bannerslider\Controller\Adminhtml\AbstractAction
{
    /**
    ...
    {
        return $this->_authorization->isAllowed('SM_Bannerslider::bannerslider_reports');
    }
}
