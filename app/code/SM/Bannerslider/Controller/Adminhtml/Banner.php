 ...
 * @author   SM Developer
 */
abstract class Banner extends \SM\Bannerslider\Controller\Adminhtml\AbstractAction
{
    ...
    {
        return $this->_authorization->isAllowed('SM_Bannerslider::bannerslider_banners');
    }
