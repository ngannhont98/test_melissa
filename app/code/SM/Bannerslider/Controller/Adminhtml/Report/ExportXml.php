 ...
 * @author   SM Developer
 */
class ExportXml extends \SM\Bannerslider\Controller\Adminhtml\Report
{
    public function execute()
    {
        ...
        $content = $resultPage->getLayout()->createBlock('SM\Bannerslider\Block\Adminhtml\Report\Grid')->getXml();
